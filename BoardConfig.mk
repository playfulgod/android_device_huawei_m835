...
-include vendor/huawei/m835/BoardConfigVendor.mk

PRODUCT_SPECIFIC_DEFINES += TARGET_PRELINKER_MAP=device/huawei/m835/include/prelink-linux-arm.map
...
# Recovery
TARGET_PREBUILT_RECOVERY_KERNEL := device/huawei/m835/recovery_kernel
...
BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := M835
...
TARGET_OTA_ASSERT_DEVICE := M835
PRODUCT_BUILD_PROP_OVERRIDES += TARGET_BOOTLOADER_BOARD_NAME=M835
TARGET_BOOTLOADER_BOARD_NAME := M835

TARGET_PREBUILT_KERNEL := device/huawei/m835/kernel
